...
export function Topbar({ onMenuClick }: TopbarProps = {}) {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 px-2 sm:px-3 md:px-4 lg:px-6 backdrop-blur-xl">
